...
import img1 from '../../../assets/logos/shades.jpg';
import img2 from '../../../assets/logos/spectacles.png';
import img3 from '../../../assets/logos/accessories.png';
...
const Glassess = () => {
    return (
        <div className='mt-24 mb-20'>
            <div className='my-20 flex flex-row items-center mx-5 md:mx-10'>
                <hr className='border-black border w-full' />
                <h2 className='text-4xl font-semibold italic text-center px-4 md:px-8'>Our Products</h2>
                <hr className='border-black border w-full' />
            </div>
            ...
            <div className='mx-6 md:mx-11 grid gap-6 md:grid-cols-2 lg:grid-cols-3'>
                ...
                <div className="card card-compact bg-base-100 shadow-xl border-2">
                    ...
                    <div className="card-body">
                        <h2 className="card-title text-3xl mx-auto">Shades</h2>
                        <p></p>
                        <div className="card-actions justify-end">
                            <button className=" btn-sm btn btn-accent w-full"> <a href="https://www.facebook.com/messages/t/105394095633208" target='_blank' rel="noreferrer" >More info</a></button>
                        </div>
                    </div>
                </div>
                ...
                <div className="card card-compact bg-base-100 shadow-xl border-2">
                    ...
                    <div className="card-body">
                        <h2 className="card-title text-3xl mx-auto">Spectacles</h2>
                        <p></p>
                        <div className="card-actions justify-end">
                            <button className=" btn-sm btn btn-accent w-full"> <a href="https://www.facebook.com/messages/t/105394095633208" target='_blank' rel="noreferrer" >More info</a></button>
                        </div>
                ...
                <div className="card card-compact bg-base-100 shadow-xl border-2">
                    ...
                    <div className="card-body">
                        <h2 className="card-title text-3xl mx-auto">Accessories</h2>
                        <p></p>
                        <div className="card-actions justify-end">
                            <button className=" btn-sm btn btn-accent w-full"> <a href="https://www.facebook.com/messages/t/105394095633208" target='_blank' rel="noreferrer" >More info</a></button>
                        </div>
